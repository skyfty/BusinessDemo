define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'business_background/inventor/index' + location.search,
                    add_url: 'business_background/inventor/add',
                    edit_url: 'business_background/inventor/edit',
                    del_url: 'business_background/inventor/del',
                    multi_url: 'business_background/inventor/multi',
                    import_url: 'business_background/inventor/import',
                    table: 'inventor',
                }
            });
